...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags) {
    ...
    // Render
    it_anim->second.background = ImLerp(it_anim->second.background, IsItemActive() || hovered ? ColorConvertU32ToFloat4(ImColor(219, 187, 99)) : ColorConvertU32ToFloat4(ImColor(199, 167, 79)), 0.2f);
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    anim_state.CurrentColor = ImLerp(anim_state.CurrentColor, target_color, g.IO.DeltaTime * 7.0f); // Ajuste o fator de velocidade (10.0f) conforme necessário
